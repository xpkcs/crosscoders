...
def get_scheduler_lr(optimizer, total_steps=CONSTANTS.EXPERIMENT.MAX_BATCHES, decay_start_fraction=0.8):
...
def get_scheduler_lambda_s(lambda_s_max, total_steps=CONSTANTS.EXPERIMENT.MAX_BATCHES):
